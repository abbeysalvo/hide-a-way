...
const Footer = ({ ...props }) => {
  return (
    <footer className="footer" role="contentinfo">
      <div className="footer__content flex--justify-space-between flex--column tablet:flex--row width-full">
        ...
        <div className="footer__content flex--wrap margin-left-auto">
          <div className="footer__column">
      ...
      <div className="footer__copyright flex--justify-space-between width-full">
